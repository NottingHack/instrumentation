...
nh-macmon: nh-macmon.o CNHmqtt.o INIReader.o ini.o CLogging.o db/lib/CNHDBAccess.o CMacmon.o 
	g++ -lpcap -lmysqlclient -lmosquitto -o nh-macmon CNHmqtt.o nh-macmon.o INIReader.o ini.o CLogging.o db/lib/CNHDBAccess.o CMacmon.o
	cp nh-macmon bin/
