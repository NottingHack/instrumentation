...
class CGatekeeper_door
{
  public:
    ...
    virtual void set_opts(int id, std::string base_topic, CLogging *log, CNHDBAccess *db, InstCBI *cb, std::string entry_announce, int read_timeout, std::string door_state) = 0;
};
